...
-- Policy: Admin bisa melakukan semua operasi (via service_role key)
-- Catatan: Untuk operasi admin, gunakan Supabase service_role key
-- yang bypass RLS secara otomatis.
